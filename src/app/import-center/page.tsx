...
import { SapImportTab } from '@/components/sap/SapImportTab';
import { Upload, Sparkles, AlertTriangle, CheckCircle, Loader2, Plus, FileSpreadsheet, ScanSearch, Database } from 'lucide-react';
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div>
                    ...
                    <p className="text-slate-500 mt-2 text-lg">
                        Scan documents, import spreadsheets, or sync from SAP
                    </p>
                </div>
